...
dash.register_page(__name__, path='/A', name="Company Performance", external_stylesheets=[dbc.themes.BOOTSTRAP])
...
no1 = dbc.CardBody(
        [
            ...
            html.H4(id='Registration', style={'color': 'blue', 'fontSize': 70,'textAlign': 'center'}),
...
def update_graph_B3(oil_company_name, monthly_option_list):
    ...
    fig = px.bar(data_frame = filtered_df2, x =['Average_Registration_Time','Average_Update_Profile_Time'], y='Oil_and_Gas_Company_Name', orientation = 'h', color_discrete_map={'Average_Update_Profile_Time':'orange', 'Average_Registration_Time':'blue'},barmode='group')
